 ...
 */
public class IoTBatchDataConnectionDeleteRequest extends IoTRequest{
    public IoTBatchDataConnectionDeleteRequest() {
        super(IoTRequestId.BatchDataConnectDeleteReq_Id);
    }
}
